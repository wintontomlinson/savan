      ...
      <div className="relative flex-1 flex flex-col overflow-y-auto">
        ...
        <div className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-8 px-6 pb-8">
          ...
          <div className="flex-shrink-0">
            <div className={`w-[280px] h-[280px] sm:w-[320px] sm:h-[320px] lg:w-[380px] lg:h-[380px] rounded-2xl overflow-hidden shadow-2xl ${isPlaying ? 'animate-spin-slow' : ''}`}
          ...
          {/* Song Info & Controls */}
          <div className="flex flex-col items-center lg:items-start gap-6 w-full max-w-md">
            {/* Song Info */}
            <div className="text-center lg:text-left">
              <h1 className="text-2xl sm:text-3xl font-bold text-white mb-2">{currentSong.title}</h1>
              <p className="text-lg text-[#AAAAAA]">{currentSong.artist}</p>
            ...
            <div className="flex items-center gap-6 w-full justify-center lg:justify-start">
              ...
              <button
                onClick={togglePlay}
                className="w-14 h-14 bg-white rounded-full flex items-center justify-center hover:scale-105 transition-transform duration-200 shadow-xl"
              >
                {isPlaying ? (
            ...
            <div className="flex items-center gap-4 w-full justify-center lg:justify-start">
              ...
              <button
                ...
                className="p-2 text-[#AAAAAA] hover:text-white rounded-full transition-colors duration-200"
              >
                <PlusCircle size={22} />
              </button>
              <button className="p-2 text-[#AAAAAA] hover:text-white rounded-full transition-colors duration-200">
                <Mic2 size={22} />
              </button>
              <button
                onClick={() => showToast('Premium feature')}
                className="p-2 text-[#AAAAAA] hover:text-white rounded-full transition-colors duration-200 relative"
              >
                <Download size={22} />
