        ...
        <div className="flex items-center justify-between p-4 border-b border-white/5">
          ...
          <div className="flex items-center gap-2">
            {queue.length > 0 && (
              <button
                onClick={clearQueue}
                className="p-2 rounded-full hover:bg-white/10 transition-colors text-[#AAAAAA] hover:text-white"
              >
                <Trash2 size={18} />
              </button>
            )}
          ...
          {queue.length === 0 ? (
            ...
            <div className="space-y-1">
              {queue.map((song, index) => (
                ...
                >
                  <GripVertical size={16} className="text-[#AAAAAA] flex-shrink-0 cursor-grab" />
                  <img
                    src={song.image}
                    alt=""
