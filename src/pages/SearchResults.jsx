      ...
      <div className="relative mb-6 sticky top-0 z-20 bg-[#060606]/90 backdrop-blur-xl pb-3 -mx-1 px-1 pt-1">
        <form onSubmit={handleSubmit} className="relative">
          ...
          <input
            ...
            className="w-full bg-white/[0.04] text-white text-[14px] pl-12 pr-12 py-4 rounded-2xl placeholder:text-white/25 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:bg-white/[0.06] transition-all duration-300 border border-white/[0.05] focus:border-rose-500/20"
            autoComplete="off"
            spellCheck="false"
          />
          {query && (
